        ...
        try:
            with st.spinner("Procesando y limpiando datos..."):
                ...
                if df_ifs is not None:
                    ...
                    # Validación ajustada a 39
                    if len(i_cols) < 39:
                        st.error("El archivo IFS no parece tener la estructura correcta (requiere al menos 39 columnas para llegar a la columna AM).")
                        st.stop()

                    # Nuevos índices aplicados
